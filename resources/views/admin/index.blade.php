        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-info o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">{{$tin_dang_doi}} Tin  đợi duyệt</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="{{route('tintuc.index.private')}}">
              <span class="float-left">Chi Tiết</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-secondary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">{{$lienhe}} Liên Hệ</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="{{route('get.admin.lienhe')}}">
              <span class="float-left">Chi Tiết</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
